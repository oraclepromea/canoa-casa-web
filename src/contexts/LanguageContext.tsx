...
const translations: Translations = {
  ...
  'accommodations.double.private.title': { en: 'Double Room with Private Bathroom', es: 'Habitación Doble con Baño Privado' },
  'accommodations.double.private.desc': { en: 'Comfortable double room with private bathroom, perfect for couples seeking privacy', es: 'Habitación doble cómoda con baño privado, perfecta para parejas que buscan privacidad' },
  'accommodations.double.shared.title': { en: 'Double Room with Shared Bathroom', es: 'Habitación Doble con Baño Compartido' },
  'accommodations.double.shared.desc': { en: 'Cozy double room with shared bathroom facilities, great value for couples', es: 'Habitación doble acogedora con baño compartido, excelente valor para parejas' },
  'accommodations.dorm4.private.title': { en: '4-Bed Dorm with Private Bathroom', es: 'Dormitorio 4 Camas con Baño Privado' },
  'accommodations.dorm4.private.desc': { en: '4-bed dormitory with private bathroom, ideal for small groups', es: 'Dormitorio de 4 camas con baño privado, ideal para grupos pequeños' },
  'accommodations.dorm.shared.title': { en: '3-4 Bed Dorm with Shared Bathroom', es: 'Dormitorio 3-4 Camas con Baño Compartido' },
  'accommodations.dorm.shared.desc': { en: 'Budget-friendly dormitory with shared bathroom, perfect for backpackers', es: 'Dormitorio económico con baño compartido, perfecto para mochileros' },
